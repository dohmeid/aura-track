...
const FormInput: FC<AuraInputProps> = ({ id, label, type = 'text', icon: Icon, placeholder, name, error, value = '', onChange }) => {
    ...
    return (
        <div className="relative mb-6">
            ...
            <div
                ...
                `}
            >
                <span className="p-3 text-gray-400"><Icon className="w-5 h-5" /></span>
                <input
                    id={id}
