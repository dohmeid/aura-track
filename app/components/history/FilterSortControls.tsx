...
const FilterLink = ({ value, label, type, activeFilter, activeSort }: FilterLinkProps) => {
    ...
    <div className="flex flex-col h-full bg-white/60 backdrop-blur-md border border-white/60 rounded-[30px] shadow-sm hover:shadow-lg transition-all duration-300 p-6">
      ...
      <div className="mb-6">
        ...
        <nav className="flex flex-col gap-2 p-1 bg-white/50 rounded-2xl border border-white/40">
          <div className="grid grid-cols-2 gap-2">
            <FilterLink type="filter" value="all" label="All Time" activeFilter={activeFilter} activeSort={activeSort} />
            <FilterLink type="filter" value="week" label="Past Week" activeFilter={activeFilter} activeSort={activeSort} />
            <FilterLink type="filter" value="month" label="Past Month" activeFilter={activeFilter} activeSort={activeSort} />
            <FilterLink type="filter" value="year" label="Past Year" activeFilter={activeFilter} activeSort={activeSort} />
          </div>
        </nav>
      </div>
      ...
      <div>
        ...
        <nav className="flex p-1 bg-white/50 rounded-2xl border border-white/40">
          <FilterLink type="sort" value="newest" label="Newest First" activeFilter={activeFilter} activeSort={activeSort} />
          <FilterLink type="sort" value="oldest" label="Oldest First" activeFilter={activeFilter} activeSort={activeSort} />
        </nav>
      </div>
    </div>
  );
